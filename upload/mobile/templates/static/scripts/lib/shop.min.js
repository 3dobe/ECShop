...
function countdown(c,g){function p(c,g,l){var r="",k=!1,w=0,z=0,A=0,m=0,w=Math.round(+new Date/1E3),m=g-w;if(0>=m)"function"===typeof l&&l();else return e||(0<Math.floor(m/86400)&&(w=Math.floor(m/86400),m%=86400,r+=w+"婢讹拷",k=!0),0<Math.floor(m/3600)&&(z=Math.floor(m/3600),m%=3600,k=!0)),k&&(r+=" "+z+"閺冿拷",k=!0),!e&&0<Math.floor(m/60)&&(A=Math.floor(m/60),m%=60,k=!0),k&&(r+=" "+A+"閸掞拷",k=!0),0<Math.floor(m)&&(k=!0),k&&(r+=" "+m+"缁夛拷",k=!0),c.innerHTML=r,setTimeout(function(){p(c,g,l)},1E3)}g=$.extend({start:60,
